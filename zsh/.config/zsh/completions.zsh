...
'*--allow=[Permission allow rule (Claude Code\: --allowedTools)]:RULE:_default' \
'*--deny=[Permission deny rule (Claude Code\: --disallowedTools)]:RULE:_default' \
...
'--output-format=[Output format for headless mode]:OUTPUT_FORMAT:(plain json streaming-json)' \
...
'--system-prompt-override=[Override the agent'\''s system prompt (Claude Code\: --system-prompt)]:PROMPT:_default' \
'(-c --continue -s --session-id)-r+[Resume a session by ID, or the most recent if omitted]::SESSION_ID:_default' \
'(-c --continue -s --session-id)--resume=[Resume a session by ID, or the most recent if omitted]::SESSION_ID:_default' \
'(-c --continue -s --session-id)--load=[Resume a previous session by session ID (alias for --resume)]:SESSION_ID:_default' \
'(-r --resume --load -c --continue)-s+[Create or resume a session with a specific ID (upsert semantics). If the session exists, it is loaded; otherwise a new session is created with the given ID. Hidden from --help]:SESSION_ID:_default' \
'(-r --resume --load -c --continue)--session-id=[Create or resume a session with a specific ID (upsert semantics). If the session exists, it is loaded; otherwise a new session is created with the given ID. Hidden from --help]:SESSION_ID:_default' \
'-w+[Start the session in a new git worktree, optionally named]::WORKTREE:_default' \
'--worktree=[Start the session in a new git worktree, optionally named]::WORKTREE:_default' \
...
'(--no-subagents)--best-of-n=[Run the task N ways in parallel and pick the best (headless only)]:N:_default' \
...
'--hunk-tracker-mode=[Hunk tracker mode\: agent_only or all_dirty]:MODE:_default' \
'--installer=[Set the installer field in config.toml]:VALUE:_default' \
'--hub-url=[Computer Hub WebSocket URL for tool sharing]:URL:_default' \
'--hub-workspace-mode=[Workspace mode\: "local" (default) or "remote=<server-id>"]:MODE:_default' \
'-v[Print version]' \
'--version[Print version]' \
'--debug[Enable debug logging]' \
'--always-approve[Auto-approve all tool executions]' \
'--verbatim[Send the prompt exactly as given]' \
'(-r --resume --load -s --session-id)-c[Continue the most recent session for the current working directory]' \
'(-r --resume --load -s --session-id)--continue[Continue the most recent session for the current working directory]' \
...
'(--no-memory)--experimental-memory[Enable cross-session memory]' \
'(--experimental-memory)--no-memory[Disable cross-session memory for this session]' \
'--disable-web-search[Disable web search and web fetch tools]' \
'(--no-subagents)--check[Append a self-verification loop to the prompt (headless only)]' \
...
'-h[Print help]' \
'--help[Print help]' \
'*::targets -- Session IDs or .jsonl paths to import. Omit to import all available sessions:_default' \
&& ret=0
;;
(inspect)
_arguments "${_arguments_options[@]}" : \
...
'-h[Print help]' \
'--help[Print help]' \
":: :_grok__subcmd__leader__subcmd__profile_commands" \
"*::: :->profile" \
&& ret=0
    ...
    (profile)
        words=($line[1] "${words[@]}")
        (( CURRENT += 1 ))
        curcontext="${curcontext%:*:*}:grok-leader-profile-command-$line[1]:"
        case $line[1] in
            (status)
_arguments "${_arguments_options[@]}" : \
'--pid=[Leader process ID from \`grok leader list\`]:PID:_default' \
...
_arguments "${_arguments_options[@]}" : \
'--pid=[Leader process ID from \`grok leader list\`]:PID:_default' \
'--output=[Output path for the profile]:OUTPUT:_files' \
'--frequency-hz=[Sampling frequency in Hz]:FREQUENCY_HZ:_default' \
'--leader-socket=[Use a custom leader socket path instead of the default \`~/.grok/leader.sock\`]:PATH:_files' \
'--debug-file=[Write debug logs to FILE]:FILE:_files' \
'--json[]' \
'--debug[Enable debug logging]' \
...
(help)
_arguments "${_arguments_options[@]}" : \
":: :_grok__subcmd__leader__subcmd__profile__subcmd__help_commands" \
"*::: :->help" \
&& ret=0
    ...
    (help)
        words=($line[1] "${words[@]}")
        (( CURRENT += 1 ))
        curcontext="${curcontext%:*:*}:grok-leader-profile-help-command-$line[1]:"
        case $line[1] in
            (status)
_arguments "${_arguments_options[@]}" : \
&& ret=0
...
(profile)
_arguments "${_arguments_options[@]}" : \
":: :_grok__subcmd__leader__subcmd__help__subcmd__profile_commands" \
"*::: :->profile" \
&& ret=0
    ...
    (profile)
        words=($line[1] "${words[@]}")
        (( CURRENT += 1 ))
        curcontext="${curcontext%:*:*}:grok-leader-help-profile-command-$line[1]:"
        case $line[1] in
            (status)
_arguments "${_arguments_options[@]}" : \
&& ret=0
...
'(--device-auth --devbox)--oauth[Use Grok OAuth via auth.x.ai]' \
'(--oauth --devbox)--device-auth[Use device-code authentication for headless/remote environments]' \
'(--oauth --devbox)--device-code[Use device-code authentication for headless/remote environments]' \
'(--oauth --device-auth)--devbox[Mint credentials via explorer-service (devbox pods only)]' \
'--debug[Enable debug logging]' \
'-h[Print help]' \
'--help[Print help]' \
&& ret=0
...
'-h[Print help]' \
'--help[Print help]' \
':url -- Git URL or GitHub shorthand (e.g. user/repo):_default' \
&& ret=0
;;
(remove)
_arguments "${_arguments_options[@]}" : \
...
'-h[Print help]' \
'--help[Print help]' \
':url -- Git URL or local path of the source to remove:_default' \
&& ret=0
;;
(update)
_arguments "${_arguments_options[@]}" : \
...
'-h[Print help (see more with '\''--help'\'')]' \
'--help[Print help (see more with '\''--help'\'')]' \
'*::args -- Arguments forwarded to ssh (e.g. user@host, -t, -L ...):_default' \
&& ret=0
;;
(export)
_arguments "${_arguments_options[@]}" : \
...
(profile)
_arguments "${_arguments_options[@]}" : \
":: :_grok__subcmd__help__subcmd__leader__subcmd__profile_commands" \
"*::: :->profile" \
&& ret=0
    ...
    (profile)
        words=($line[1] "${words[@]}")
        (( CURRENT += 1 ))
        curcontext="${curcontext%:*:*}:grok-help-leader-profile-command-$line[1]:"
        case $line[1] in
            (status)
_arguments "${_arguments_options[@]}" : \
&& ret=0
...
'share:Share a session and print the share URL (internal only)' \
...
(( $+functions[_grok__subcmd__help__subcmd__import_commands] )) ||
_grok__subcmd__help__subcmd__import_commands() {
    local commands; commands=()
    _describe -t commands 'grok help import commands' commands "$@"
}
...
'profile:Manage CPU profiling for a leader process' \
    )
...
(( $+functions[_grok__subcmd__help__subcmd__leader__subcmd__profile_commands] )) ||
_grok__subcmd__help__subcmd__leader__subcmd__profile_commands() {
    local commands; commands=(
'status:Show profiling status' \
'start:Start CPU profiling' \
'stop:Stop CPU profiling' \
    )
    _describe -t commands 'grok help leader profile commands' commands "$@"
}
(( $+functions[_grok__subcmd__help__subcmd__leader__subcmd__profile__subcmd__start_commands] )) ||
_grok__subcmd__help__subcmd__leader__subcmd__profile__subcmd__start_commands() {
    local commands; commands=()
    _describe -t commands 'grok help leader profile start commands' commands "$@"
}
(( $+functions[_grok__subcmd__help__subcmd__leader__subcmd__profile__subcmd__status_commands] )) ||
_grok__subcmd__help__subcmd__leader__subcmd__profile__subcmd__status_commands() {
    local commands; commands=()
    _describe -t commands 'grok help leader profile status commands' commands "$@"
}
(( $+functions[_grok__subcmd__help__subcmd__leader__subcmd__profile__subcmd__stop_commands] )) ||
_grok__subcmd__help__subcmd__leader__subcmd__profile__subcmd__stop_commands() {
    local commands; commands=()
    _describe -t commands 'grok help leader profile stop commands' commands "$@"
}
...
'add:Add a marketplace source (git URL or GitHub shorthand)' \
...
(( $+functions[_grok__subcmd__help__subcmd__ssh_commands] )) ||
_grok__subcmd__help__subcmd__ssh_commands() {
    local commands; commands=()
    _describe -t commands 'grok help ssh commands' commands "$@"
}
...
(( $+functions[_grok__subcmd__import_commands] )) ||
_grok__subcmd__import_commands() {
    local commands; commands=()
    _describe -t commands 'grok import commands' commands "$@"
}
...
(( $+functions[_grok__subcmd__leader__subcmd__help__subcmd__profile_commands] )) ||
_grok__subcmd__leader__subcmd__help__subcmd__profile_commands() {
    local commands; commands=(
'status:Show profiling status' \
'start:Start CPU profiling' \
'stop:Stop CPU profiling' \
    ...
    _describe -t commands 'grok leader help profile commands' commands "$@"
}
(( $+functions[_grok__subcmd__leader__subcmd__help__subcmd__profile__subcmd__start_commands] )) ||
_grok__subcmd__leader__subcmd__help__subcmd__profile__subcmd__start_commands() {
    local commands; commands=()
    _describe -t commands 'grok leader help profile start commands' commands "$@"
}
(( $+functions[_grok__subcmd__leader__subcmd__help__subcmd__profile__subcmd__status_commands] )) ||
_grok__subcmd__leader__subcmd__help__subcmd__profile__subcmd__status_commands() {
    local commands; commands=()
    _describe -t commands 'grok leader help profile status commands' commands "$@"
}
(( $+functions[_grok__subcmd__leader__subcmd__help__subcmd__profile__subcmd__stop_commands] )) ||
_grok__subcmd__leader__subcmd__help__subcmd__profile__subcmd__stop_commands() {
    local commands; commands=()
    _describe -t commands 'grok leader help profile stop commands' commands "$@"
}
...
(( $+functions[_grok__subcmd__leader__subcmd__profile_commands] )) ||
_grok__subcmd__leader__subcmd__profile_commands() {
    local commands; commands=(
'status:Show profiling status' \
'start:Start CPU profiling' \
...
'help:Print this message or the help of the given subcommand(s)' \
    ...
    _describe -t commands 'grok leader profile commands' commands "$@"
}
(( $+functions[_grok__subcmd__leader__subcmd__profile__subcmd__help_commands] )) ||
_grok__subcmd__leader__subcmd__profile__subcmd__help_commands() {
    local commands; commands=(
'status:Show profiling status' \
'start:Start CPU profiling' \
...
'help:Print this message or the help of the given subcommand(s)' \
    ...
    _describe -t commands 'grok leader profile help commands' commands "$@"
}
(( $+functions[_grok__subcmd__leader__subcmd__profile__subcmd__help__subcmd__help_commands] )) ||
_grok__subcmd__leader__subcmd__profile__subcmd__help__subcmd__help_commands() {
    local commands; commands=()
    _describe -t commands 'grok leader profile help help commands' commands "$@"
}
(( $+functions[_grok__subcmd__leader__subcmd__profile__subcmd__help__subcmd__start_commands] )) ||
_grok__subcmd__leader__subcmd__profile__subcmd__help__subcmd__start_commands() {
    local commands; commands=()
    _describe -t commands 'grok leader profile help start commands' commands "$@"
}
(( $+functions[_grok__subcmd__leader__subcmd__profile__subcmd__help__subcmd__status_commands] )) ||
_grok__subcmd__leader__subcmd__profile__subcmd__help__subcmd__status_commands() {
    local commands; commands=()
    _describe -t commands 'grok leader profile help status commands' commands "$@"
}
(( $+functions[_grok__subcmd__leader__subcmd__profile__subcmd__help__subcmd__stop_commands] )) ||
_grok__subcmd__leader__subcmd__profile__subcmd__help__subcmd__stop_commands() {
    local commands; commands=()
    _describe -t commands 'grok leader profile help stop commands' commands "$@"
}
(( $+functions[_grok__subcmd__leader__subcmd__profile__subcmd__start_commands] )) ||
_grok__subcmd__leader__subcmd__profile__subcmd__start_commands() {
    local commands; commands=()
    _describe -t commands 'grok leader profile start commands' commands "$@"
}
(( $+functions[_grok__subcmd__leader__subcmd__profile__subcmd__status_commands] )) ||
_grok__subcmd__leader__subcmd__profile__subcmd__status_commands() {
    local commands; commands=()
    _describe -t commands 'grok leader profile status commands' commands "$@"
}
(( $+functions[_grok__subcmd__leader__subcmd__profile__subcmd__stop_commands] )) ||
_grok__subcmd__leader__subcmd__profile__subcmd__stop_commands() {
    local commands; commands=()
    _describe -t commands 'grok leader profile stop commands' commands "$@"
}
...
(( $+functions[_grok__subcmd__ssh_commands] )) ||
_grok__subcmd__ssh_commands() {
    local commands; commands=()
    _describe -t commands 'grok ssh commands' commands "$@"
}
